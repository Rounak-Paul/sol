...
static const char *const SOL_DEFAULT_BINDINGS_CONF =
    ...
    "#   file.new                Open a new empty buffer.\n"
    "#   file.close              Close the current file's buffer.\n"
    "#   buffer.close            Close the active buffer.\n"
    "#   buffer.focus.previous   Show the previously focused buffer.\n"
    ...
    "#   split.focus.next        Move focus to the next split/pane.\n"
    "#   split.focus.prev        Move focus to the previous split/pane.\n"
    "#   split.horizontal        Split the active pane horizontally.\n"
    "#   split.vertical          Split the active pane vertically.\n"
    "#   explorer.focus.toggle   Toggle explorer focus/visibility.\n"
    "#\n"
    "# Plugins may register additional actions. Add bindings here to wire\n"
    "# them to chords without touching Sol's source.\n"
    "\n"
    "bind ctrl f f            file.new\n"
    "bind ctrl f x            file.close\n"
    ...
    "bind ctrl s h            split.horizontal\n"
    "bind ctrl s v            split.vertical\n"
    "bind ctrl s n            split.focus.next\n"
    "bind ctrl s p            split.focus.prev\n"
